...
const debug = require('debug')('hyperdrive-archiver')
...
Archiver.prototype.remove = function () {
  this.ar.remove.apply(this.ar, arguments)
}

Archiver.prototype.add = function () {
  this.ar.add.apply(this.ar, arguments)
}

Archiver.prototype.list = function () {
  this.ar.list.apply(this.ar, arguments)
}
